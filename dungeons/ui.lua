...
local 主UI=ZUI:new(DevScreen,{align="left",w=90,h=100,size=20,cancelname="取消",okname="OK",countdown=0,config="dungeonsui",xpos=2})
local 主配置=Page:new(主UI,{text="主功能选择",size=20})
主配置:nextLine() 
主配置:addLabel({text="脚本功能--地下城",size=30,align="Left",w=20,color="255,0,0"})
主配置:nextLine()
